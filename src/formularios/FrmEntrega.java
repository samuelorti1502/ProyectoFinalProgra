...
public class FrmEntrega extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelTituloLayout.setHorizontalGroup(
            ...
            .addGroup(panelTituloLayout.createSequentialGroup()
                ...
                .addGroup(panelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 273, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2.add(btnEntregar, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jPanel2.add(btnImprimir, gridBagConstraints);
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        PDFClass pdfClass = new PDFClass("Entrega", 1);

        pdfClass.pdfSolDev(this.lblSolicitud.getText(), this.txtNombres.getText(), this.txtApellidos.getText(), this.txtMarcaBici.getText(),
                this.txtModeloBici.getText());

        // <editor-fold defaultstate="collapsed" desc="PDF V1">
    ...
    private void btnEntregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntregarActionPerformed
        try {
            ...
            Path pQr = FileSystems.getDefault().getPath("images/QR/" + codigo + "E.png");
            ...
            EntregaClass entregaClass = new EntregaClass(this.lblSolicitud.getText(), this.txtFecha.getText(), this.txtHora.getText(), this.txtNombres.getText(),
                    this.txtApellidos.getText(), this.txtCodBici.getText(), this.txtMarcaBici.getText(), this.txtModeloBici.getText(), this.lblUsuario.getText());
    ...
    public String hora() {
        ...
        hr = (getHora() <= 9 ? "0" + getHora() : getHora()) + ":" + (getMinuto() <= 9 ? "0" + getMinuto() : getMinuto()) + ":"
                + (getSegundo() <= 9 ? "0" + getSegundo() : getSegundo());
        return hr;
    }
